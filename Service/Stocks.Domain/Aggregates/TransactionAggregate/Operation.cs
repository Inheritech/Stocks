...
namespace Stocks.Domain.Aggregates.TransactionAggregate {
    ...
    public class Operation : Enumeration {
        ...
        /// <exception cref="InvalidTransactionOperationTypeException">Thrown if the name provided is not a valid operation type.</exception>
        public static Operation FromName(string name) {
            ...
            if (operation == null)
                throw new InvalidTransactionOperationTypeException(name);
